<template>
	<div class="map">
		<search :fatherMethod='fatherMethod'></search>
...
export default {
	methods: {
		 fatherMethod(start,end) {
			 this.transfer.search([
			     {keyword: start ,city:'合肥'},
	...
	created() {
		AMapLoader.load({
		    "key": "2396e702c4b4141e89475eee6874a6f9",              // 申请好的Web端开发者Key，首次调用 load 时必填
		    "version": "2.0",   // 指定要加载的 JSAPI 的版本，缺省时默认为 1.4.15
		    "plugins": ['AMap.ToolBar','AMap.Transfer','demoutils'],           // 需要使用的的插件列表，如比例尺'AMap.Scale'等
		}).then((AMap)=>{
